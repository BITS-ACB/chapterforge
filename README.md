...
with embedded chapter markers** — one chapter per source file, titled from the
filename. Review and edit the chapter list, set the master's ID3 tags and cover
art, and save. Built with wxPython, FFmpeg and Mutagen.
